    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-8 lg:px-12 relative z-10">
      ...
      >
        <div className="flex flex-col mb-6">
          ...
          <span className="bg-primary-100/70 dark:bg-primary-950/60 w-10 border border-primary-200/80 dark:border-primary-800 rounded-full px-1 py-0.5 mb-4" />
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 items-start">
        ...
        <aside className={`lg:col-span-1 bg-white dark:bg-slate-800 rounded-2xl p-5 border border-neutral-200/80 dark:border-slate-700/80 shadow-sm space-y-5 sticky top-24 ${isMobileFilterOpen ? "block" : "hidden lg:block"}`}>
          <div className="flex items-center justify-between border-b border-neutral-100 dark:border-slate-700 pb-3">
